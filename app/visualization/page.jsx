...
export default function VisualizationPage() {
  const [chartData] = useState([
    { date: "2018", newUsers: 125000, activeUsers: 450000, retention: 0.78, conversionRate: 0.12 },
    { date: "2019", newUsers: 187000, activeUsers: 680000, retention: 0.76, conversionRate: 0.13 },
    { date: "2020", newUsers: 256000, activeUsers: 920000, retention: 0.79, conversionRate: 0.14 },
    { date: "2021", newUsers: 342000, activeUsers: 1250000, retention: 0.81, conversionRate: 0.15 },
    { date: "2022", newUsers: 458000, activeUsers: 1680000, retention: 0.82, conversionRate: 0.15 },
  ])
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-gray-900 mb-2">Growth Visualization</h1>
      <p className="text-gray-600 mb-8">Visualize your user growth trends with interactive charts</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="card">
            ...
            <div className="h-[400px] relative">
              {isLoading ? (
                ...
                <GrowthChart data={chartData} type={chartType} showLabels={showLabels} />
              )}
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-1">
          <div className="card h-full">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Chart Options</h2>
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block mb-2 text-gray-700">Metrics to Display</label>
