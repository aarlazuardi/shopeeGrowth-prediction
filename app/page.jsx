  ...
  const features = [
    {
      ...
      description:
        "Kelola dan visualisasikan data pertumbuhan pengguna Anda dengan tabel dan grafik interaktif",
    ...
    },
    {
      ...
      description:
        "Terapkan berbagai metode interpolasi numerik untuk memprediksi pertumbuhan masa depan",
    ...
    },
    {
      ...
      description:
        "Analisis hasil prediksi dan bandingkan metode interpolasi yang berbeda",
    ...
    <div className="container mx-auto px-4 py-12">
      <div className="text-center mb-16">
        <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-4">
          Prediksi Pertumbuhan Pengguna <span className="text-[#FF6B00]">Shopee</span>
        </h1>
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Prediksi pertumbuhan pengguna Shopee di Asia Tenggara menggunakan data historis dan metode interpolasi numerik. Lihat tren pengguna, lakukan simulasi prediksi, dan analisis pertumbuhan secara interaktif.
        </p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-md overflow-hidden">
        <div className="p-8">
          ...
          <p className="text-gray-600 mb-6">
            Mulai perjalanan prediksi pertumbuhan Anda dengan mengimpor data Anda atau menggunakan dataset sampel kami untuk menjelajahi kemampuan platform.
          </p>
